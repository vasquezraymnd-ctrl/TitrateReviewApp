  ...
  return (
    <div className="flex h-screen bg-[#0b111a] overflow-hidden text-white">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar relative">
        ...
        <div className="max-w-7xl xl:max-w-[1600px] mx-auto px-6 md:px-10 lg:px-12 xl:px-16 py-24 md:py-16 lg:py-20 xl:py-32 flex flex-col min-h-full">
            ...
            {step === 'subject' && (
              <div className="space-y-12 xl:space-y-20 animate-in fade-in duration-700">
                <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/5 pb-8 gap-6">
                    ...
                    {!isOnline && (
                      <div className="flex items-center gap-2 bg-red-500/10 border border-red-500/20 px-4 py-2 rounded-none animate-pulse">
                        <WifiOff size={14} className="text-red-500" />
                        <span className="text-[10px] font-black uppercase text-red-500 tracking-widest">Laboratory Offline</span>
                      </div>
                    )}
                </div>
